...
import { T, Card, Pill, Dot, Icon, icons } from '../../design/primitives';
import { GROWTH_SCHEMA, STANDARD_CURVE, GR_DATA } from '../../data/growth';
...
const btnSecondary = (label, icon) => (
  <button style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '8px 14px', borderRadius: 7, border: `1px solid ${T.border}`, background: T.surface, color: T.muted, fontSize: 12, fontWeight: 600, cursor: 'pointer' }}>
    {icon && <Icon d={icon} size={14} c={T.muted} />}{label}
  </button>
);
...
export { GrowthDashboardScreen, GrowthInputScreen, GrowthMarkerDetailScreen, GrowthHeatmapScreen };
