...
export default function ChatbotFab() {
  ...
  return (
    <button
      ...
      onClick={openPanel}
      aria-label="챗봇 열기"
      className="fixed bottom-6 right-6 z-[60] w-14 h-14 rounded-full bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white shadow-lg flex items-center justify-center transition-colors"
    >
      💬
    </button>
  );
