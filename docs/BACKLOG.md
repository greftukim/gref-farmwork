...
| HQ-FINANCE-001 | 데이터 보완 | 조사완료·구현대기 | 세션 22 (2026-04-22) 등록 → 세션 51 (2026-04-25) 조사 | - | HQFinanceScreen 전체 하드코딩. 재무 테이블 전무(attendance/employees 임금 컬럼 없음, harvest_records 단가 없음) 확인. 설계 완료: docs/DESIGN_HQ_FINANCE_001.md (2 신설 테이블: finance_monthly + finance_budgets, Gate 5건, 3 Phase). 세션 52 Phase 1 구현 예정. | docs/DESIGN_HQ_FINANCE_001.md |
