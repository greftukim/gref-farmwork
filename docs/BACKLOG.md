...
| GROWTH-INPUT-SESSION39-001 | 기능 미구현 | open | 세션 38 (2026-04-24) | P2 | 주별 생육 기록 입력 UI — 현재 GrowthInputScreen은 read-only 목업. 실제 INSERT 구현 필요 (세션 39). 동적 측정 항목, 파생 컬럼 자동 계산, 저장·제출 액션. | docs/BACKLOG.md |
