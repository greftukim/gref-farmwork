...
| PC-FLOOR-DATA-001 | 기능 미구현 | open | 세션 73-C (2026-04-26) | - | PC FloorPlan.jsx도 floor-schema.js mock 데이터 전용. WORKERS_MAP·ACTIVE_ASSIGNMENTS 하드코딩. QR 위치 추적 실데이터 Tier 6 예정. MOBILE-FLOOR-001과 동일 트랙. | docs/BACKLOG.md |
